  ...
  <div class="px-6 py-6 border-t border-orange-100 flex flex-col gap-2">
    <div class="flex items-center gap-3">
      <div>
        ...
        <div class="text-sm text-orange-600 font-bold"><span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-orange-100 text-orange-600 font-bold text-xl"><?php echo strtoupper(substr($userName,0,2)); ?></span></div>
      </div>
    </div>
